...
catalogo = Catalogo(host='micaelaalijo.mysql.pythonanywhere-services.com', user='micaelaalijo', password='40259042m', database='micaelaalijo$miapp')
...
RUTA_DESTINO = '/home/micaelaalijo/mysite/static/img/'
...
@app.route('/listadoEliminar.html')
def eliminar():
    return render_template('listadoEliminar.html')
@app.route('/modificaciones.html')
def modificar():
